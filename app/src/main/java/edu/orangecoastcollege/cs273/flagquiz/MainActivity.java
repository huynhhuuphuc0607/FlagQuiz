...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadNextFlag() {
        ...
        try {
            ...
            Drawable drawable = Drawable.createFromStream(is, mCorrectCountry.getName());
    ...
    public void makeGuess(View v) {
        ...
        if (guess.equals(mCorrectCountry.getName())) {
            ...
            if (mCorrectGuesses < FLAGS_IN_QUIZ) {
                ...
                mBuilder.setPositiveButton(getString(R.string.reset_quiz), new DialogInterface.OnClickListener() {
                    @Override
